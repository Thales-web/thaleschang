...
export const textTranslations = {
  ko: {
    ...
    contact_page_description: "프로젝트에 대해 상담하고 싶으시면 언제든지 연락주세요. 빠른 시일 내에 답변 드리겠습니다.",
    contact_page_title: "문의하기",
    send_message: "메시지 보내기",
    book_appointment: "상담 예약",
    book_appointment_description: "고객님의 모든 요구에 도움을 드립니다. 상담을 요청하거나 궁금한 점을 남겨주세요.",
    office_hours_weekday: "월요일 - 금요일: 오전 8:00 - 오후 6:00",
    office_hours_saturday: "토요일: 오전 9:00 - 오후 1:00",
    office_hours_sunday: "일요일: 휴무",
    contact_phone_number: "(555) 123-4567",
    contact_email_address: "info@medicaloffice.com",
    emergency_phone_number: "(555) 911-0000",
    office_hours: "영업 시간",
    contact_info: "연락처",
    phone: "전화",
    email: "이메일",
    ...
    faq_title: "자주 묻는 질문",
    faq_description: "서비스와 진행 과정에 대한 일반적인 질문에 대한 답변을 확인하세요",
    faq_description_side: "궁금한 점이 해결되지 않으시면 전화 또는 메시지로 문의해 주세요.",
    faq_still_questions: "더 궁금한 점이 있으신가요?",
  ...
  en: {
    ...
    contact_page_description: "Have a project in mind? Feel free to reach out. We'll get back to you as soon as possible.",
    ...
    faq_description: "Find answers to common questions about our services and process",
    faq_description_side: "If your question is not answered here, please call or message our office.",
